...
public class Sql2oTaskDaoTest {
    ...
    @Test
    public void getAll_getsAllTasks_2() throws Exception{
        Task task = new Task("mow the lawn");
        Task otherTask = new Task("do some other lame shit");
        taskDao.add(task);
    ...
    @Test
    public void getAll_getsNoTasksWhenNonePresent_0() throws Exception{
        assertEquals(0, taskDao.getAll().size());
    }

    @Test
    public void update_updatesTask_mowTheChickens() throws Exception{
        Task task = new Task("mow the lawn");
        taskDao.add(task);
        taskDao.update(1, "mow the chickens");
        Task foundTask = taskDao.findById(task.getId());
        assertEquals("mow the chickens", foundTask.getDescription());
    }

    @Test
    public void delete_deletesById_1() throws Exception{
        Task task = new Task("mow the lawn");
